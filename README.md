...
- 🥇 Selected as **GSSOC’25 Contributor** among 10,000+ applicants for open-source impact.  
- ✅ Certified in **MLOps, Machine Learning, AWS Solutions Architecture, and Cybersecurity**.  
- 🚀 Deployed 5+ full-stack applications on **Render, Hugging Face, and GitHub Pages**.  

---

### 🎓 Licenses & Certifications  
- AWS - Solutions Architecture Job Simulation (Forage)  
- AWS Certified DevOps Engineer - Learning Plan (AWS)  
- AWS Certified Machine Learning - Plan (AWS)  
- MLOps: From Model Development to Deployment (Udemy)  
- Machine Learning - Full Course with Python (Udemy)  
- Machine Learning Fundamentals (Udemy)  
